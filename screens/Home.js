...
import {Text, View, TouchableOpacity, StyleSheet,Platform, StatusBar,SafeAreaView, Image,Platform,ImageBackground} from 'react-native';
     ...
     routeText: { fontSize: 35,
      ...
      75, paddingLeft: 30 },
       knowMore: { paddingLeft: 30, color: "red", fontSize: 15 },
        bgDigit: { position: "absolute", color: "rgba(183, 183, 183, 0.5)", fontSize: 150, right: 20, bottom: -15, zIndex: -1 }, iconImage: { position: "absolute", height: 200, width: 200, resizeMode: "contain", right: 20,
      top: -80 }
